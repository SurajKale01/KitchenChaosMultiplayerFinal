...
public class LobbyUI : MonoBehaviour
{
    ...
    [SerializeField] private Transform lobbyTemplete;
    ...
    private void Awake()
    {
        ...
        lobbyTemplete.gameObject.SetActive(false);
    }
    ...
    private void UpdateLobbyList(List<Lobby> lobbyList)
    {
        ...
        {
            Transform lobbyTransform = Instantiate(lobbyTemplete, lobbyContainer);
